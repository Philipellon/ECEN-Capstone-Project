...
// -------- Voice confidence thresholds (per command) --------
#define CONF_THR_FORWARD   0.95f
#define CONF_THR_BACKWARD  0.90f
#define CONF_THR_LEFT      0.88f
#define CONF_THR_RIGHT     0.92f
#define CONF_THR_STOP      0.35f
...
static inline float threshold_for(Command c) {
    switch (c) {
        case CMD_FORWARD: return CONF_THR_FORWARD;
        case CMD_BACK:    return CONF_THR_BACKWARD;
        case CMD_LEFT:    return CONF_THR_LEFT;
        case CMD_RIGHT:   return CONF_THR_RIGHT;
